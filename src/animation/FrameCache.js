 ...
 * Uses a sliding-window algorithm that evicts the frames furthest
 * from the active scroll index to enforce strict desktop and mobile caps.
 */
export class FrameCache {
  ...
  constructor(limitBytes = 384 * 1024 * 1024) {
    ...
    this.cache = new Map(); // frameIndex => ImageBitmap
    this.hits = 0;
    this.misses = 0;
  }
   ...
   * @param {number} currentIndex - The viewport's active frame index
   */
